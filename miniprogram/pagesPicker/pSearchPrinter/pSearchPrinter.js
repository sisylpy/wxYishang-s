...
Page({
  ...
  onLoad: function (options) {
    ...
    if(app.BLEInformation.deviceId == null){
      this.startSearch();
    }else{
      this.setData({
...
// ====================
  bindViewTap: function (e) {
    ...
    wx.createBLEConnection({
      ...
      success: function (res) {
        console.log("zhengzailainjie:::::::,xiamianshi res====")
        console.log(res)
  ...
  getSeviceId: function () {
    ...
    wx.getBLEDeviceServices({
      deviceId: app.BLEInformation.deviceId,
      success: function (res) {
        console.log("get seviceididididiidid&&&getBLEDeviceServices--------------")
        console.log(res)
        // var realId = ''
        // if (platform == 'android') {
  ...
  openControl: function () {
    ...
    // })
    console.log("------opnec-controallallalalallal")
    var that = this;
    wx.notifyBLECharacteristicValueChange({
      ...
      state: true,
      success: function(res) {
        console.log("notifyBLECharacteristicValueChange::1111111111")
