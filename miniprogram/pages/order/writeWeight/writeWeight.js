...
Page({
    ...
    getToFillDepOrders(data)
      .then(res => {
        if (res) {
          ...
          // res.result.data[0].onFocus = true;
  ...
  inputValue(e) {
    ...
    if (this.data.depHasSubs == 0) {
      ...
      // begin
      var oldValue = this.data.applyArr[this.data.focusIndex].nxDoWeight;
      ...
      if (value == ".") {
        ...
        if (value == "next") {
          ...
          console.log(this.data.applyArr.length)
    ...
    if (this.data.depHasSubs == 1) {
      ...
      console.log(this.data.depArr[this.data.focusParentIndex])
      // begin
      var oldValue = this.data.depArr[this.data.focusParentIndex].depOrders[this.data.focusIndex].nxDoWeight;
      ...
      if (value <= 9 && value >= 0) {
        ...
        this.setData({
          ["depArr[" + this.data.focusParentIndex + "].depOrders[" + this.data.focusIndex + "]nxDoWeight"]: newValue
        })
      ...
      if (value == ".") {
        // oldValue = this.data.applyArr[this.data.focusIndex].nxDoWeight;
        oldValue = this.data.depArr[this.data.focusParentIndex].depOrders[this.data.focusIndex].nxDoWeight
        console.log(oldValue);
        console.log("kankanoldvalue")
        var newValue = 0;
        if (oldValue.indexOf(".") != -1) {
    ...
    if (this.data.depHasSubs == 1) {
      ...
      for (var i = 0; i < depArr.length; i++) {
        for (var j = 0; j < depArr[i].depOrders.length; j++) {
          var weight = depArr[i].depOrders[j].nxDoWeight;

          if (weight > 0) {
            var apply = {
              nxDepartmentOrdersId: depArr[i].depOrders[j].nxDepartmentOrdersId,
              nxDoWeight: depArr[i].depOrders[j].nxDoWeight,
